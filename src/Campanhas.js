...
class Campanhas extends Component {
    ...
    handleDonate(key) {
        axios.post('https://us-central1-bora-judar-7ba7f.cloudfunctions.net/api/donate', {
            campanha: key,
                        ...
                        <div className='p-5 rounded'>
                            ...
                            { campanha.tipo === 'doacao' &&  <div>
                                <div className='progress'>
                                    <div className='progress-bar bg-success' style={{ width: parseInt(porcentagem)+'%' }} role='progressbar' aria-valuenow='25' aria-valuemin='0' aria-valuemax='100'></div>
                                </div>
