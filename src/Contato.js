                        ...
                        <div className='col-xl-9 mx-auto'>
                            <div className='cta-inner text-center rounded'>
                                ...
                                <ul className='list-unstyled list-hours mb-5 text-left mx-auto'>
                                    <li className='list-unstyled-item list-hours-item d-flex'>Sunday
                                        <span className='ml-auto'>Closed</span>
                                    </li>
                                    <li className='list-unstyled-item list-hours-item d-flex'>Monday
                                        <span className='ml-auto'>7:00 AM to 8:00 PM</span>
                                    </li>
                                    <li className='list-unstyled-item list-hours-item d-flex'>Tuesday
                                        <span className='ml-auto'>7:00 AM to 8:00 PM</span>
                                    </li>
                                    <li className='list-unstyled-item list-hours-item d-flex'>Wednesday
                                        <span className='ml-auto'>7:00 AM to 8:00 PM</span>
                                    </li>
                                    <li className='list-unstyled-item list-hours-item d-flex'>Thursday
                                        <span className='ml-auto'>7:00 AM to 8:00 PM</span>
                                    </li>
                                    <li className='list-unstyled-item list-hours-item d-flex'>Friday
                                        <span className='ml-auto'>7:00 AM to 8:00 PM</span>
                                    </li>
                                    <li className='list-unstyled-item list-hours-item d-flex'>Saturday
